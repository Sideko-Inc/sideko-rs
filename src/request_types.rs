...
pub struct GetApiVersionRequest {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(id = "version-id-or-semver", long = "version-id-or-semver")
    )]
...
pub struct ListSdksRequest {
    #[cfg_attr(feature = "cli", arg(id = "api-id-or-name", long = "api-id-or-name"))]
...
pub struct UpdateApiProjectRequest {
    ...
    pub project_id_or_name: String,
    #[cfg_attr(feature = "cli", command(flatten))]
    pub data: crate::models::UpdateApiProject,
}
#[cfg_attr(feature = "cli", derive(clap::Args))]
#[derive(serde::Serialize, serde::Deserialize, Debug, Default, Clone)]
pub struct UpdateApiVersionRequest {
    ...
    pub version_id_or_semver: String,
    #[cfg_attr(feature = "cli", command(flatten))]
    pub data: crate::models::UpdateApiVersion,
}
#[cfg_attr(feature = "cli", derive(clap::Args))]
#[derive(serde::Serialize, serde::Deserialize, Debug, Default, Clone)]
...
pub struct CreateApiProjectRequest {
    #[cfg_attr(feature = "cli", command(flatten))]
    pub data: crate::models::NewApiProject,
}
#[cfg_attr(feature = "cli", derive(clap::Args))]
#[derive(serde::Serialize, serde::Deserialize, Debug, Default, Clone)]
...
pub struct CreateApiVersionRequest {
    ...
    pub project_id_or_name: String,
    #[cfg_attr(feature = "cli", command(flatten))]
    pub data: crate::models::NewApiVersion,
}
#[cfg_attr(feature = "cli", derive(clap::Args))]
#[derive(serde::Serialize, serde::Deserialize, Debug, Default, Clone)]
...
pub struct UpdateSdkRequest {
    ...
    #[cfg_attr(
        feature = "cli",
        arg(id = "api-version-id-or-semver", long = "api-version-id-or-semver")
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
