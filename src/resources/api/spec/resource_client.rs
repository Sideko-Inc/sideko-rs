...
impl SpecClient {
    ...
    pub fn openapi(&self) -> crate::resources::api::spec::openapi::resource_client::OpenapiClient {
        crate::resources::api::spec::openapi::resource_client::OpenapiClient::new(
            self.base_client.clone(),
        )
    }
    pub fn stats(&self) -> crate::resources::api::spec::stats::resource_client::StatsClient {
        crate::resources::api::spec::stats::resource_client::StatsClient::new(
            self.base_client.clone(),
        )
    }
    ...
    pub async fn delete(
        ...
        let url = self.base_client.build_url(&format!(
            "/api/{}/spec/{}",
            crate::core::params::format_string_param(&request.api_name),
            crate::core::params::format_string_param(&request.api_version)
        ));
    ...
    pub async fn list(
        ...
        crate::core::response::process_json::<Vec<crate::models::ApiSpec>>(response).await
    }
    /// no description available
    pub async fn get(
        &self,
    ...
    pub async fn patch(
        ...
        if let Some(val) = &request.data.notes {
            form_data = form_data.part("notes", reqwest::multipart::Part::text(val.to_string()));
        }
        ...
        if let Some(val) = &request.data.version {
            form_data = form_data.part("version", reqwest::multipart::Part::text(val.to_string()));
        }
